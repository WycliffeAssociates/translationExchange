...
//Download Page Constants
export const DOWNLOADS_LIST_SUCCESS = 'DOWNLOADS_LIST_SUCCESS';
export const DOWNLOADS_LIST_FAILED = 'DOWNLOADS_LIST_FAILED';
export const DOWNLOADS_LIST_LOADING = 'DOWNLOADS_LIST_LOADING';
