...
export class ExportCard extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if ( nextProps.completedSelected !== this.props.completedSelected || nextProps.allSelected !== this.props.allSelected) { //check if the state of the button select completed changed
      if ((nextProps.completedSelected && nextProps.published) || nextProps.allSelected) {                // button selected and the chapter is published, mark them as selected
      ...
      if ((!nextProps.completedSelected || (nextProps.completedSelected && !nextProps.published)) && !nextProps.allSelected) {   // once we check the checkbox
